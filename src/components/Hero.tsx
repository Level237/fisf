...
export default function Hero() {
  ...
  <div className='absolute bg-[#00723e] h-24 flex gap-5 flex-row justify-center items-center px-12 border border-white border-[0.1rem]  top-[-2rem] z-[9999] '>
          ...
          <div className=''>
              <div className='flex flex-row justify-between items-end gap-5'>
                  <h2 className='text-2xl font-semibold text-white'>Actualités</h2>
                    <Separator className='bg-white h-7 w-1' orientation='vertical' />
                </div>
          ...
          <div className=''>
          <div className='flex flex-row justify-between items-end gap-5'>
              <h2 className='text-2xl font-semibold text-white'>Classement</h2>
                <Separator className='bg-white h-7 w-1' orientation='vertical' />
            </div>
          </div>
          <div className=''>
          <div className='flex flex-row justify-between items-end gap-5'>
              <h2 className='text-2xl font-semibold text-white'>Evènements</h2>
                <Separator className='bg-white h-7 w-1' orientation='vertical' />
            </div>
          </div>
          <div className=''>
