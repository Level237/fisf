...
export const MissionPage=()=>{
    ...
    className='w-full z-10 mt-5 h-96  bg-[#02abee]  rounded-md relative  justify-start pt-20 flex flex-col items-center'>
            ...
            <section className="flex flex-col mt-12 mx-36">
                    ...
                    <div className="mt-6">
                        <p className="text-xl mb-5 text-justify">Entrez dans le monde de la FISF, la réunion de toutes les fédérations et associations de
                        Scrabble® francophone et des près de 20 000 joueurs qui les composent !</p>
                                    <p className="text-xl mb-5 text-justify">Depuis sa création, la FISF a été guidée par la volonté d'aider les scrabbleurs de tous
                                            les pays à ses structurer, et poursuit son action, notamment, envers les prometteuses
                                            fédérations africaines.
                                    </p>

                                    <p className="text-xl mb-5 text-justify">La Fédération internationale de Scrabble® francophone (FISF) a pour missions
                                    ...
                                    <p className="text-xl mb-5 text-justify">Par le travail de ses membres, et en particulier grâce à l’apport et à la réflexion de ses
                    ...
                    <div className="mx-6">
                                    <h2 className="text-2xl text-red-700 underline underline-offset-[15px] mb-4 text-justify">Sur Le plan de la promotion et du développement</h2>
                                    ...
                                    <div className="">
                                        <h2 className="text-2xl text-red-700 underline underline-offset-[15px] mb-4">Sur le plan du jeu et de sa pratique en compétition</h2>
                                        <div className="mx-4 mt-8">
                                                <li className="text-xl mb-4 text-justify">
                                    ...
                                    <div className="mt-12 mb-12">
                                        <img src={slide2} className="h-80 w-full" alt="" />
                                    </div>
                    </div>
            </section>
            <Footer/>
